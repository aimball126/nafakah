					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">قراءة الكل</span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">يوجد 4 إشعارات</p>
									</div>
									<div class="main-notification-list Notification-scroll">
										<a class="d-flex p-3 border-bottom" href="#">
											...
											<div class="mr-3">
												<h5 class="notification-label mb-1">حالة تأخير</h5>
										...
										<a class="d-flex p-3" href="#">
											...
											<div class="mr-3">
												<h5 class="notification-label mb-1">تم سداد نفقة</h5>
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/6.png')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/6.png')}}" class=""></div>
											<div class="mr-3 my-auto">
												<h6>د. عدنان</h6><span>أدمن</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>حسابي</a>
									<a class="dropdown-item" href="{{url('/editprofile') }}"><i class="bx bx-cog"></i>تعديل حسابي</a>
